...
public class API1 {
	...
	public void simpleStatusCode() {
		...
		when().get("http://34.203.227.227:1000/ords/hr/employees")
		.then().statusCode(200);
	}
	...
	public void printResponse() {
		...
		when().get("http://34.203.227.227:1000/ords/hr/countries")
		.body().prettyPrint();
	}
	...
	public void negativeGet() {
		...
		when().get("http://34.203.227.227:1000/ords/hr/employees/1234")
		.then().statusCode(404);
	}
	...
	public void negativeGetWithBody() {
		...
		Response response = when().get("http://34.203.227.227:1000/ords/hr/employees/1234");
	...
	public void verifyContentType() {
		...
		given().accept(ContentType.JSON)
		.when().get("http://34.203.227.227:1000/ords/hr/employees/110")
